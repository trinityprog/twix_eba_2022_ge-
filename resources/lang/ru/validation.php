...
return [
    ...
    */
    ...
    'custom' => [
        'time' => [
            'date_format' => 'Введи время выдачи чека в формате ЧЧ:ММ'
        ],
        'phone' => [
            'exists' => 'Упс, этот телефон у нас не зарегистрирован.',
            'unique' => 'Упс, пользователь с таким номером уже зарегистрирован.',
        ],
        'sms' => [
            'exists' => 'Неверный код, попробуй еще раз',
        ],
