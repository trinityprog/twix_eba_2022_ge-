...
return [
    ...
    */
    ...
    'custom' => [
        'phone' => [
            'exists' => 'Упс, бұл телефон бізде тіркелмеген.',
            'unique' => 'Упс, мұндай нөмірі бар пайдаланушы қазірдің өзінде тіркелген.',
        ],
        'code' => [
            'exists' => 'SMS коды дұрыс емес, қайталап көріңіз',
        ],
        'auth_failed' => 'Телефон нөмірі немесе SMS коды дұрыс емес.',
    ],
