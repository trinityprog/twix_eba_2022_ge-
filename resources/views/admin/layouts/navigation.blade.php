<aside class="z-20 hidden w-64 overflow-y-auto bg-white md:block flex-shrink-0">
    <div class="py-4 text-gray-500">
        <a class="ml-6 text-lg font-bold text-gray-800" href="{{ route('index') }}">
            {{ env('APP_NAME') }}
        </a>
        ...
        <ul class="mt-6">
            ...
            <li class="relative px-6 py-3">
                <x-nav-link href="{{ route('admin.test_users.index') }}" :active="request()->routeIs('admin.test_users.index')">
                    <x-slot name="icon">
            ...
            <li class="relative px-6 py-3">
                <x-nav-link href="{{ route('admin.checks.index') }}" :active="request()->routeIs('admin.checks.index')">
                    <x-slot name="icon">
            ...
            <li class="relative px-6 py-3">
                <x-nav-link href="{{ route('admin.scanners.index') }}" :active="request()->routeIs('admin.scanners.index')">
                    <x-slot name="icon">
            ...
            <li class="relative px-6 py-3">
                <x-nav-link href="{{ route('admin.winners.index') }}" :active="request()->routeIs('admin.winners.index')">
                    <x-slot name="icon">
                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5 5a3 3 0 015-2.236A3 3 0 0114.83 6H16a2 2 0 110 4h-5V9a1 1 0 10-2 0v1H4a2 2 0 110-4h1.17C5.06 5.687 5 5.35 5 5zm4 1V5a1 1 0 10-1 1h1zm3 0a1 1 0 10-1-1v1h1z" clip-rule="evenodd"></path><path d="M9 11H3v5a2 2 0 002 2h4v-7zM11 18h4a2 2 0 002-2v-5h-6v7z"></path></svg>
                    </x-slot>
                    Победители
                </x-nav-link>
            </li>
            ...
            <li class="relative px-6 py-3">
                <x-nav-link href="{{ route('admin.delivery_regions.index') }}" :active="request()->routeIs('admin.delivery_regions.index')">
                    <x-slot name="icon">
                    ...
                    Области в форме доставки
                </x-nav-link>
            </li>

            <li class="relative px-6 py-3">
                <x-nav-link href="{{ route('admin.deliveries.index') }}" :active="request()->routeIs('admin.deliveries.index')">
                    <x-slot name="icon">
                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.083 9h1.946c.089-1.546.383-2.97.837-4.118A6.004 6.004 0 004.083 9zM10 2a8 8 0 100 16 8 8 0 000-16zm0 2c-.076 0-.232.032-.465.262-.238.234-.497.623-.737 1.182-.389.907-.673 2.142-.766 3.556h3.936c-.093-1.414-.377-2.649-.766-3.556-.24-.56-.5-.948-.737-1.182C10.232 4.032 10.076 4 10 4zm3.971 5c-.089-1.546-.383-2.97-.837-4.118A6.004 6.004 0 0115.917 9h-1.946zm-2.003 2H8.032c.093 1.414.377 2.649.766 3.556.24.56.5.948.737 1.182.233.23.389.262.465.262.076 0 .232-.032.465-.262.238-.234.498-.623.737-1.182.389-.907.673-2.142.766-3.556zm1.166 4.118c.454-1.147.748-2.572.837-4.118h1.946a6.004 6.004 0 01-2.783 4.118zm-6.268 0C6.412 13.97 6.118 12.546 6.03 11H4.083a6.004 6.004 0 002.783 4.118z" clip-rule="evenodd"></path></svg>
                    </x-slot>
                    Адреса доставки
            ...
            <li class="relative px-6 py-3">
                <x-nav-link href="{{ route('admin.rules.index') }}" :active="request()->routeIs('admin.rules.index')">
                    <x-slot name="icon">
            ...
            <li class="relative px-6 py-3">
                <span class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"></path>
                    </svg>
                    <span class="ml-4">Тесты</span>
                </span>
            </li>

            <li class="relative px-6 py-3">
                <x-nav-link class="ml-6" href="{{ route('admin.tests.questions.index') }}" :active="request()->routeIs('admin.tests.questions.index')">
                    Вопросы
                </x-nav-link>
            </li>

            <li class="relative px-6 py-3">
                <x-nav-link class="ml-6" href="{{ route('admin.tests.results.index') }}" :active="request()->routeIs('admin.tests.results.index')">
                    Результаты
                </x-nav-link>
            </li>
        </ul>
